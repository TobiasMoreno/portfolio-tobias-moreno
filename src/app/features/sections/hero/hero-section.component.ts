      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="animate-fade-in-up flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            <h1 class="text-4xl sm:text-5xl font-bold tracking-tight text-fg">
              Tobias Moreno
            </h1>
            <p class="text-base font-medium text-muted tracking-wide">
              {{ locale.t('hero.tagline') }}
            </p>
          </div>
          ...
          <div class="flex flex-wrap gap-3">
            <a [routerLink]="'/'" [fragment]="'projects'"
               class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-accent text-white text-sm font-medium hover:opacity-90 transition-opacity">
              {{ locale.t('hero.cta_projects') }}
            </a>
            <a [routerLink]="'/'" [fragment]="'contact'"
               class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border text-fg text-sm font-medium hover:border-accent transition-colors">
          ...
          <div class="flex flex-wrap items-center gap-4 pt-2">
            <a href="https://github.com/TobiasMoreno" target="_blank" rel="noopener"
               class="flex items-center gap-1.5 text-sm text-muted hover:text-fg transition-colors">
            ...
            <a href="https://drive.google.com/file/d/1CVj8CjdPSItd1qcKQpO7Hpu6bb98BKRB/view" target="_blank" rel="noopener"
               class="text-sm text-muted hover:text-fg transition-colors px-2.5 py-1 rounded border border-border hover:border-accent">
              {{ locale.t('hero.cv_es') }}
            </a>
        ...
        <div class="animate-fade-in-up-delay flex justify-center md:justify-end">
          <div class="relative w-64 h-64 sm:w-80 sm:h-80 rounded-2xl overflow-hidden border border-border">
